...
export const essentialCookies = [
  {
    ...
    description: "This cookie records whether or not the cookie notification pop-up has been acknowledged by the user, including whether or not you permit us to use Google Analytics (GA).",
    cookies: "ICDSPREF",
  },
  {
