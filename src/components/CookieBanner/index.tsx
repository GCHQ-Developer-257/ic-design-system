...
const CookieBanner: React.FC = () => {
  ...
  const { handleCookieConsent, handleLocalStorageConsent } = useContext(CookieConsentContext);
      ...
      {submitted ? (
        <ic-section-container full-height aligned="full-width" tab-index="-1">
          <ic-typography role="alert" variant="body">
            ...
            <ic-link>
              <GatsbyLink slot="router-item" to="/icds/cookies-and-storage-policy">
        ...
        <ic-section-container full-height aligned="full-width">
          <ic-typography variant="h2">Cookies and Storage on this site</ic-typography>
          <ic-typography variant="body">
            We’d like to use analytics cookies to understand how you use the Design System, so that we can make improvements. Additionally, we use local storage to improve your experience by remembering your preferences.
          </ic-typography>
          <div className="buttons">
